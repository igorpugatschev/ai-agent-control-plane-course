...
```bash
test -s artifacts/module-02/source-register.md
test -s artifacts/module-02/context-packet.md
test -s artifacts/module-02/context-map-evidence-gate.md
grep -Eqi 'Source owner|Authority owner|check date|SHA' artifacts/module-02/source-register.md
grep -Eqi 'Citations|trusted|untrusted|exclusions' artifacts/module-02/context-packet.md
grep -Eqi 'Evidence gate|STOP|unsupported implementation|resume' artifacts/module-02/context-map-evidence-gate.md
