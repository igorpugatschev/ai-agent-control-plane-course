...
-> risk analysis -> recommendation or STOP -> human owner final approval for
intended action -> bounded resume
```
...
recommendation or STOP -> human approval только при реально privileged intended
action. Failure path: untrusted
