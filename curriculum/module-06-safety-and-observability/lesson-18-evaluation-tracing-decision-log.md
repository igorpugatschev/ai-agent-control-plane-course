...
OpenTelemetry задает semantic conventions для telemetry, но не требует
логировать весь prompt/response. Сначала data minimization и redaction policy,
...
- [OpenTelemetry GenAI semantic conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/) -
  официальный источник telemetry terms; конкретная redaction policy определена
  этим уроком и локальными contracts.
